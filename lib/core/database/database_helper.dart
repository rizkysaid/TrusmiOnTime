...
class DatabaseHelper{
  static final _databaseName = "TrusmiOnTime.db";
  static final _databaseVersion = 1;

  static final table = 'tbl_ip_address';
  static final columnId = 'id_ip';
  static final columnName = 'name';
  static final columnIpAddress = 'ip_address';
  static final columnIsActive = 'is_active';
