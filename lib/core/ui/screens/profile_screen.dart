...
//    }
  ...
  Future<void> getProfil(userID, date) async {
    ...
    if (response == null) {
      ...
      // totalWork = response.data.totalWork.toString();
      photoProfile = response.data.fotoProfil.toString();
      dateIn = response.data.dateIn.toString();
      dateOut = response.data.dateOut.toString();

      idShift = response.data.idShift.toString();
      shiftIn = response.data.shiftIn.toString();
      shiftOut = response.data.shiftOut.toString();
      ...
      try {
        if (response.status == true) {
          ...
          // print("dateId=>" + dateId);
          // print("dataClockIn=>" + dataClockIn);
          // print("dataClockOut=>" + dataClockOut);
