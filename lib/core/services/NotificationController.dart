...
class NotificationController extends ChangeNotifier {
  ...
  static Future<void> startListeningNotificationEvents() async {
    AwesomeNotifications()
        ...
        onNotificationDisplayedMethod: onNotificationDisplayedMethod, // Jika notifikasi muncul
        onNotificationCreatedMethod: onNotificationCreatedMethod, // KETIKA NOTIFIKASI DIBUAT
  ...
  static Future<void> onActionReceivedMethod(
    ...
    if(receivedAction.buttonKeyInput == 'reset'){
  ...
  static Future<void> onNotificationCreatedMethod(
      ReceivedNotification receivedNotification) async {
    print("JIKA NOTIFIKASI DIBUAT");
  }

  @pragma('vm:entry-point')
  static Future<void> onDismissActionReceivedMethod(
      ReceivedNotification receivedNotification) async {
    print("JIKA NOTIFIKASI DIHAPUS");
    AwesomeNotifications().decrementGlobalBadgeCounter();
  }
  ...
  static Future<void> createNewNotification(context) async {
    ...
    await AwesomeNotifications().createNotification(
        content: NotificationContent(
            id: DateTime.now().millisecondsSinceEpoch.remainder(100000), // -1 is replaced by a random number
            channelKey: 'alerts',
